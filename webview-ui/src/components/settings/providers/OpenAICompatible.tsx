...
export const OpenAICompatibleProvider = ({
	...
	const { openAiModelInfo } = getModeSpecificFields(
		apiConfiguration,
		currentMode,
	);
	...
	return (
		<div>
			<Tooltip>
				...
				<TooltipContent
					hidden={remoteConfigSettings?.openAiBaseUrl === undefined}
				>
					...
					<div style={{ marginBottom: 10 }}>
						...
						>
							<Tooltip>
								...
								<TooltipContent
									hidden={remoteConfigSettings?.openAiHeaders === undefined}
								>
				...
				<>
					<VSCodeCheckbox
						...
						onChange={(e: any) => {
							...
							handleModeFieldChange(
								{
									plan: "planModeOpenAiModelInfo",
									act: "actModeOpenAiModelInfo",
								},
								modelInfo,
								currentMode,
							);
