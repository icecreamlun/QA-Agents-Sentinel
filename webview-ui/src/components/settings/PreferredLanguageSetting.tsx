	...
	return (
		<div style={{}}>
			<label
				...
				htmlFor="preferred-language-dropdown"
			>
				Preferred Language
			</label>
			<VSCodeDropdown
			...
			>
				...
				<VSCodeOption value="Portuguese - Português (Brasil)">
				...
				<VSCodeOption value="Hungarian - Magyar">
					Hungarian - Magyar
				</VSCodeOption>
				<VSCodeOption value="Italian - Italiano">
					Italian - Italiano
				</VSCodeOption>
