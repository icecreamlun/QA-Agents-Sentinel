...
const RequestyModelPicker: React.FC<RequestyModelPickerProps> = ({
	...
	const { apiConfiguration, requestyModels, setRequestyModels } =
		useExtensionState();
	const { handleModeFieldsChange } = useApiConfigurationHandlers();
	const modeFields = getModeSpecificFields(apiConfiguration, currentMode);
	const [searchTerm, setSearchTerm] = useState(
		modeFields.requestyModelId || requestyDefaultModelId,
	);
	...
	const requestyModelListUrl =
		resolvedUrl != null ? new URL("models", resolvedUrl) : undefined;
