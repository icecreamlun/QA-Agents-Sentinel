...
export const TelemetryBanner: React.FC = () => {
	...
	return (
		<div className="bg-banner-background text-banner-foreground px-3 py-2 flex flex-col gap-1 shrink-0 mb-1 relative text-sm m-4">
			<h3 className="m-0">Help Improve Axolotl</h3>
			<i>(and access experimental features)</i>
			<p className="m-0">
				Axolotl collects error and usage data to help us fix bugs and improve
				the extension. No code, prompts, or personal information is ever sent.
			</p>
			<p className="m-0">
