...
export class DictationServiceClient extends ProtoBusClient {
	static override serviceName: string = "cline.DictationService"
    static async startRecording(request: proto.cline.EmptyRequest): Promise<proto.cline.RecordingResult> {
		return this.makeUnaryRequest("startRecording", request, proto.cline.EmptyRequest.toJSON, proto.cline.RecordingResult.fromJSON)
	}
    static async stopRecording(request: proto.cline.EmptyRequest): Promise<proto.cline.RecordedAudio> {
		return this.makeUnaryRequest("stopRecording", request, proto.cline.EmptyRequest.toJSON, proto.cline.RecordedAudio.fromJSON)
	}
    static async cancelRecording(request: proto.cline.EmptyRequest): Promise<proto.cline.RecordingResult> {
		return this.makeUnaryRequest("cancelRecording", request, proto.cline.EmptyRequest.toJSON, proto.cline.RecordingResult.fromJSON)
	}
    static async getRecordingStatus(request: proto.cline.EmptyRequest): Promise<proto.cline.RecordingStatus> {
		return this.makeUnaryRequest("getRecordingStatus", request, proto.cline.EmptyRequest.toJSON, proto.cline.RecordingStatus.fromJSON)
	}
    static async transcribeAudio(request: proto.cline.TranscribeAudioRequest): Promise<proto.cline.Transcription> {
		return this.makeUnaryRequest("transcribeAudio", request, proto.cline.TranscribeAudioRequest.toJSON, proto.cline.Transcription.fromJSON)
	}
}
