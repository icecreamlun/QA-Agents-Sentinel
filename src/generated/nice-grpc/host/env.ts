...
export const GetTelemetrySettingsResponse: MessageFns<GetTelemetrySettingsResponse> = {
  ...
  fromJSON(object: any): GetTelemetrySettingsResponse {
    return {
      isEnabled: isSet(object.isEnabled) ? settingFromJSON(object.isEnabled) : 0,
      errorLevel: isSet(object.errorLevel) ? globalThis.String(object.errorLevel) : undefined,
    };
  },
...
export interface EnvServiceImplementation<CallContextExt = {}> {
  ...
  /** Initiates a graceful shutdown of the host bridge service. */
  shutdown(request: EmptyRequest, context: CallContext & CallContextExt): Promise<DeepPartial<Empty>>;
}
...
export interface EnvServiceClient<CallOptionsExt = {}> {
  ...
  /** Initiates a graceful shutdown of the host bridge service. */
  shutdown(request: DeepPartial<EmptyRequest>, options?: CallOptions & CallOptionsExt): Promise<Empty>;
}
