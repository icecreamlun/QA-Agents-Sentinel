...
export const OpenRouterModelInfo: MessageFns<OpenRouterModelInfo> = {
  ...
  fromJSON(object: any): OpenRouterModelInfo {
    return {
      ...
      supportsReasoning: isSet(object.supportsReasoning) ? globalThis.Boolean(object.supportsReasoning) : undefined,
      apiFormat: isSet(object.apiFormat) ? apiFormatFromJSON(object.apiFormat) : undefined,
    };
  },
...
export const ModelsApiSecrets: MessageFns<ModelsApiSecrets> = {
  ...
  fromJSON(object: any): ModelsApiSecrets {
    return {
      ...
      minimaxApiKey: isSet(object.minimaxApiKey) ? globalThis.String(object.minimaxApiKey) : undefined,
  ...
  create(base?: DeepPartial<ModelsApiSecrets>): ModelsApiSecrets {
    return ModelsApiSecrets.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<ModelsApiSecrets>): ModelsApiSecrets {
    const message = createBaseModelsApiSecrets();
...
export const ModelsApiOptions: MessageFns<ModelsApiOptions> = {
  ...
  fromJSON(object: any): ModelsApiOptions {
    return {
      ...
      ocaMode: isSet(object.ocaMode) ? globalThis.String(object.ocaMode) : undefined,
      awsUseGlobalInference: isSet(object.awsUseGlobalInference)
        ? globalThis.Boolean(object.awsUseGlobalInference)
        : undefined,
      minimaxApiLine: isSet(object.minimaxApiLine) ? globalThis.String(object.minimaxApiLine) : undefined,
  ...
  create(base?: DeepPartial<ModelsApiOptions>): ModelsApiOptions {
    return ModelsApiOptions.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<ModelsApiOptions>): ModelsApiOptions {
    const message = createBaseModelsApiOptions();
...
export const ModelsApiOptions_OpenAiHeadersEntry: MessageFns<ModelsApiOptions_OpenAiHeadersEntry> = {
  ...
  create(base?: DeepPartial<ModelsApiOptions_OpenAiHeadersEntry>): ModelsApiOptions_OpenAiHeadersEntry {
    return ModelsApiOptions_OpenAiHeadersEntry.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<ModelsApiOptions_OpenAiHeadersEntry>): ModelsApiOptions_OpenAiHeadersEntry {
    const message = createBaseModelsApiOptions_OpenAiHeadersEntry();
    message.key = object.key ?? "";
...
export const UpdateApiConfigurationRequestNew: MessageFns<UpdateApiConfigurationRequestNew> = {
  ...
  create(base?: DeepPartial<UpdateApiConfigurationRequestNew>): UpdateApiConfigurationRequestNew {
    return UpdateApiConfigurationRequestNew.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<UpdateApiConfigurationRequestNew>): UpdateApiConfigurationRequestNew {
    const message = createBaseUpdateApiConfigurationRequestNew();
    message.metadata = (object.metadata !== undefined && object.metadata !== null)
      ? Metadata.fromPartial(object.metadata)
      : undefined;
...
export const UpdateApiConfigurationPartialRequest: MessageFns<UpdateApiConfigurationPartialRequest> = {
  ...
  create(base?: DeepPartial<UpdateApiConfigurationPartialRequest>): UpdateApiConfigurationPartialRequest {
    return UpdateApiConfigurationPartialRequest.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<UpdateApiConfigurationPartialRequest>): UpdateApiConfigurationPartialRequest {
    const message = createBaseUpdateApiConfigurationPartialRequest();
    message.metadata = (object.metadata !== undefined && object.metadata !== null)
      ? Metadata.fromPartial(object.metadata)
      : undefined;
...
export const ModelsApiConfiguration: MessageFns<ModelsApiConfiguration> = {
  ...
  fromJSON(object: any): ModelsApiConfiguration {
    return {
      ...
      minimaxApiKey: isSet(object.minimaxApiKey) ? globalThis.String(object.minimaxApiKey) : undefined,
      minimaxApiLine: isSet(object.minimaxApiLine) ? globalThis.String(object.minimaxApiLine) : undefined,
      hicapModelId: isSet(object.hicapModelId) ? globalThis.String(object.hicapModelId) : undefined,
      hicapApiKey: isSet(object.hicapApiKey) ? globalThis.String(object.hicapApiKey) : undefined,
      aihubmixApiKey: isSet(object.aihubmixApiKey) ? globalThis.String(object.aihubmixApiKey) : undefined,
      aihubmixBaseUrl: isSet(object.aihubmixBaseUrl) ? globalThis.String(object.aihubmixBaseUrl) : undefined,
      aihubmixAppCode: isSet(object.aihubmixAppCode) ? globalThis.String(object.aihubmixAppCode) : undefined,
      nousResearchApiKey: isSet(object.nousResearchApiKey) ? globalThis.String(object.nousResearchApiKey) : undefined,
      azureIdentity: isSet(object.azureIdentity) ? globalThis.Boolean(object.azureIdentity) : undefined,
      planModeApiProvider: isSet(object.planModeApiProvider)
        ? apiProviderFromJSON(object.planModeApiProvider)
        : undefined,
...
export interface ModelsServiceClient<CallOptionsExt = {}> {
  ...
  /** Updates API configuration (new - uses separate options and secrets) */
  updateApiConfiguration(
    request: DeepPartial<UpdateApiConfigurationRequestNew>,
    options?: CallOptions & CallOptionsExt,
  ): Promise<Empty>;
  /** Updates API configuration with partial values (only updates fields that are explicitly set) */
  updateApiConfigurationPartial(
    request: DeepPartial<UpdateApiConfigurationPartialRequest>,
    options?: CallOptions & CallOptionsExt,
  ): Promise<Empty>;
  /** Refreshes and returns Groq models */
  refreshGroqModelsRpc(
