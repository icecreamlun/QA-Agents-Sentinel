...
export const ClineModelInfo: MessageFns<ClineModelInfo> = {
  ...
  create(base?: DeepPartial<ClineModelInfo>): ClineModelInfo {
    return ClineModelInfo.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<ClineModelInfo>): ClineModelInfo {
    const message = createBaseClineModelInfo();
