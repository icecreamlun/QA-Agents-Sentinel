...
export const ToggleAgentsRuleRequest: MessageFns<ToggleAgentsRuleRequest> = {
  ...
  fromPartial(object: DeepPartial<ToggleAgentsRuleRequest>): ToggleAgentsRuleRequest {
    const message = createBaseToggleAgentsRuleRequest();
    message.metadata = (object.metadata !== undefined && object.metadata !== null)
      ? Metadata.fromPartial(object.metadata)
      : undefined;
...
export const SkillsToggles_GlobalSkillsTogglesEntry: MessageFns<SkillsToggles_GlobalSkillsTogglesEntry> = {
  ...
  create(base?: DeepPartial<SkillsToggles_GlobalSkillsTogglesEntry>): SkillsToggles_GlobalSkillsTogglesEntry {
    return SkillsToggles_GlobalSkillsTogglesEntry.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<SkillsToggles_GlobalSkillsTogglesEntry>): SkillsToggles_GlobalSkillsTogglesEntry {
    const message = createBaseSkillsToggles_GlobalSkillsTogglesEntry();
    message.key = object.key ?? "";
    message.value = object.value ?? false;
    return message;
...
export const SkillsToggles_LocalSkillsTogglesEntry: MessageFns<SkillsToggles_LocalSkillsTogglesEntry> = {
  ...
  create(base?: DeepPartial<SkillsToggles_LocalSkillsTogglesEntry>): SkillsToggles_LocalSkillsTogglesEntry {
    return SkillsToggles_LocalSkillsTogglesEntry.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<SkillsToggles_LocalSkillsTogglesEntry>): SkillsToggles_LocalSkillsTogglesEntry {
    const message = createBaseSkillsToggles_LocalSkillsTogglesEntry();
    message.key = object.key ?? "";
    message.value = object.value ?? false;
    return message;
...
export interface FileServiceImplementation<CallContextExt = {}> {
  ...
  /** Refreshes all hook toggles (discovers hooks and their enabled state) */
  refreshHooks(request: EmptyRequest, context: CallContext & CallContextExt): Promise<DeepPartial<HooksToggles>>;
  /** Toggles a hook on or off via chmod +x/-x */
  toggleHook(
  ...
  /** Refreshes all skill toggles (discovers skills and their enabled state) */
  refreshSkills(request: EmptyRequest, context: CallContext & CallContextExt): Promise<DeepPartial<RefreshedSkills>>;
  /** Toggles a skill on or off */
  toggleSkill(request: ToggleSkillRequest, context: CallContext & CallContextExt): Promise<DeepPartial<SkillsToggles>>;
  /** Creates a new skill from template */
  createSkillFile(
...
export interface FileServiceClient<CallOptionsExt = {}> {
  ...
  /** Refreshes all hook toggles (discovers hooks and their enabled state) */
  refreshHooks(request: DeepPartial<EmptyRequest>, options?: CallOptions & CallOptionsExt): Promise<HooksToggles>;
  /** Toggles a hook on or off via chmod +x/-x */
  toggleHook(
  ...
  /** Refreshes all skill toggles (discovers skills and their enabled state) */
  refreshSkills(request: DeepPartial<EmptyRequest>, options?: CallOptions & CallOptionsExt): Promise<RefreshedSkills>;
  /** Toggles a skill on or off */
  toggleSkill(request: DeepPartial<ToggleSkillRequest>, options?: CallOptions & CallOptionsExt): Promise<SkillsToggles>;
  /** Creates a new skill from template */
  createSkillFile(
