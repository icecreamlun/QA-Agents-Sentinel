...
export const HookInput: MessageFns<HookInput> = {
  ...
  create(base?: DeepPartial<HookInput>): HookInput {
    return HookInput.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<HookInput>): HookInput {
    const message = createBaseHookInput();
...
export const HookOutput: MessageFns<HookOutput> = {
  ...
  create(base?: DeepPartial<HookOutput>): HookOutput {
    return HookOutput.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<HookOutput>): HookOutput {
    const message = createBaseHookOutput();
...
export const PreToolUseData: MessageFns<PreToolUseData> = {
  ...
  create(base?: DeepPartial<PreToolUseData>): PreToolUseData {
    return PreToolUseData.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<PreToolUseData>): PreToolUseData {
    const message = createBasePreToolUseData();
...
export const PreToolUseData_ParametersEntry: MessageFns<PreToolUseData_ParametersEntry> = {
  ...
  create(base?: DeepPartial<PreToolUseData_ParametersEntry>): PreToolUseData_ParametersEntry {
    return PreToolUseData_ParametersEntry.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<PreToolUseData_ParametersEntry>): PreToolUseData_ParametersEntry {
    const message = createBasePreToolUseData_ParametersEntry();
...
export const PostToolUseData: MessageFns<PostToolUseData> = {
  ...
  create(base?: DeepPartial<PostToolUseData>): PostToolUseData {
    return PostToolUseData.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<PostToolUseData>): PostToolUseData {
    const message = createBasePostToolUseData();
    message.toolName = object.toolName ?? "";
    message.parameters = Object.entries(object.parameters ?? {}).reduce<{ [key: string]: string }>(
      (acc, [key, value]) => {
...
export const PostToolUseData_ParametersEntry: MessageFns<PostToolUseData_ParametersEntry> = {
  ...
  create(base?: DeepPartial<PostToolUseData_ParametersEntry>): PostToolUseData_ParametersEntry {
    return PostToolUseData_ParametersEntry.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<PostToolUseData_ParametersEntry>): PostToolUseData_ParametersEntry {
    const message = createBasePostToolUseData_ParametersEntry();
    message.key = object.key ?? "";
    message.value = object.value ?? "";
    return message;
...
export const UserPromptSubmitData: MessageFns<UserPromptSubmitData> = {
  ...
  create(base?: DeepPartial<UserPromptSubmitData>): UserPromptSubmitData {
    return UserPromptSubmitData.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<UserPromptSubmitData>): UserPromptSubmitData {
    const message = createBaseUserPromptSubmitData();
...
export const TaskStartData: MessageFns<TaskStartData> = {
  ...
  fromJSON(object: any): TaskStartData {
    return {
      taskMetadata: isObject(object.taskMetadata)
        ? Object.entries(object.taskMetadata).reduce<{ [key: string]: string }>((acc, [key, value]) => {
          acc[key] = String(value);
          return acc;
        }, {})
        : {},
  ...
  create(base?: DeepPartial<TaskStartData>): TaskStartData {
    return TaskStartData.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<TaskStartData>): TaskStartData {
    const message = createBaseTaskStartData();
    message.taskMetadata = Object.entries(object.taskMetadata ?? {}).reduce<{ [key: string]: string }>(
      (acc, [key, value]) => {
        if (value !== undefined) {
          acc[key] = globalThis.String(value);
        }
...
export const TaskStartData_TaskMetadataEntry: MessageFns<TaskStartData_TaskMetadataEntry> = {
  ...
  create(base?: DeepPartial<TaskStartData_TaskMetadataEntry>): TaskStartData_TaskMetadataEntry {
    return TaskStartData_TaskMetadataEntry.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<TaskStartData_TaskMetadataEntry>): TaskStartData_TaskMetadataEntry {
    const message = createBaseTaskStartData_TaskMetadataEntry();
    message.key = object.key ?? "";
    message.value = object.value ?? "";
    return message;
...
export const TaskResumeData: MessageFns<TaskResumeData> = {
  ...
  fromJSON(object: any): TaskResumeData {
    return {
      ...
      previousState: isObject(object.previousState)
        ? Object.entries(object.previousState).reduce<{ [key: string]: string }>((acc, [key, value]) => {
          acc[key] = String(value);
          return acc;
        }, {})
        : {},
  ...
  create(base?: DeepPartial<TaskResumeData>): TaskResumeData {
    return TaskResumeData.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<TaskResumeData>): TaskResumeData {
    const message = createBaseTaskResumeData();
    message.taskMetadata = Object.entries(object.taskMetadata ?? {}).reduce<{ [key: string]: string }>(
      (acc, [key, value]) => {
        if (value !== undefined) {
    ...
    message.previousState = Object.entries(object.previousState ?? {}).reduce<{ [key: string]: string }>(
      (acc, [key, value]) => {
        if (value !== undefined) {
          acc[key] = globalThis.String(value);
        }
...
export const TaskResumeData_TaskMetadataEntry: MessageFns<TaskResumeData_TaskMetadataEntry> = {
  ...
  create(base?: DeepPartial<TaskResumeData_TaskMetadataEntry>): TaskResumeData_TaskMetadataEntry {
    return TaskResumeData_TaskMetadataEntry.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<TaskResumeData_TaskMetadataEntry>): TaskResumeData_TaskMetadataEntry {
    const message = createBaseTaskResumeData_TaskMetadataEntry();
    message.key = object.key ?? "";
    message.value = object.value ?? "";
    return message;
...
export const TaskResumeData_PreviousStateEntry: MessageFns<TaskResumeData_PreviousStateEntry> = {
  ...
  create(base?: DeepPartial<TaskResumeData_PreviousStateEntry>): TaskResumeData_PreviousStateEntry {
    return TaskResumeData_PreviousStateEntry.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<TaskResumeData_PreviousStateEntry>): TaskResumeData_PreviousStateEntry {
    const message = createBaseTaskResumeData_PreviousStateEntry();
    message.key = object.key ?? "";
    message.value = object.value ?? "";
    return message;
...
export const TaskCancelData: MessageFns<TaskCancelData> = {
  ...
  create(base?: DeepPartial<TaskCancelData>): TaskCancelData {
    return TaskCancelData.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<TaskCancelData>): TaskCancelData {
    const message = createBaseTaskCancelData();
    message.taskMetadata = Object.entries(object.taskMetadata ?? {}).reduce<{ [key: string]: string }>(
      (acc, [key, value]) => {
        if (value !== undefined) {
...
export const TaskCancelData_TaskMetadataEntry: MessageFns<TaskCancelData_TaskMetadataEntry> = {
  ...
  create(base?: DeepPartial<TaskCancelData_TaskMetadataEntry>): TaskCancelData_TaskMetadataEntry {
    return TaskCancelData_TaskMetadataEntry.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<TaskCancelData_TaskMetadataEntry>): TaskCancelData_TaskMetadataEntry {
    const message = createBaseTaskCancelData_TaskMetadataEntry();
    message.key = object.key ?? "";
    message.value = object.value ?? "";
    return message;
...
export const TaskCompleteData: MessageFns<TaskCompleteData> = {
  ...
  create(base?: DeepPartial<TaskCompleteData>): TaskCompleteData {
    return TaskCompleteData.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<TaskCompleteData>): TaskCompleteData {
    const message = createBaseTaskCompleteData();
    message.taskMetadata = Object.entries(object.taskMetadata ?? {}).reduce<{ [key: string]: string }>(
      (acc, [key, value]) => {
        if (value !== undefined) {
...
export const TaskCompleteData_TaskMetadataEntry: MessageFns<TaskCompleteData_TaskMetadataEntry> = {
  ...
  create(base?: DeepPartial<TaskCompleteData_TaskMetadataEntry>): TaskCompleteData_TaskMetadataEntry {
    return TaskCompleteData_TaskMetadataEntry.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<TaskCompleteData_TaskMetadataEntry>): TaskCompleteData_TaskMetadataEntry {
    const message = createBaseTaskCompleteData_TaskMetadataEntry();
    message.key = object.key ?? "";
    message.value = object.value ?? "";
    return message;
...
export const PreCompactData: MessageFns<PreCompactData> = {
  ...
  fromJSON(object: any): PreCompactData {
    return {
      ...
      previousApiReqIndex: isSet(object.previousApiReqIndex) ? globalThis.Number(object.previousApiReqIndex) : 0,
      ...
      tokensInCache: isSet(object.tokensInCache) ? globalThis.Number(object.tokensInCache) : 0,
      tokensOutCache: isSet(object.tokensOutCache) ? globalThis.Number(object.tokensOutCache) : 0,
      deletedRangeStart: isSet(object.deletedRangeStart) ? globalThis.Number(object.deletedRangeStart) : 0,
      deletedRangeEnd: isSet(object.deletedRangeEnd) ? globalThis.Number(object.deletedRangeEnd) : 0,
      contextJsonPath: isSet(object.contextJsonPath) ? globalThis.String(object.contextJsonPath) : "",
      contextRawPath: isSet(object.contextRawPath) ? globalThis.String(object.contextRawPath) : "",
    };
  },
  ...
  create(base?: DeepPartial<PreCompactData>): PreCompactData {
    return PreCompactData.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<PreCompactData>): PreCompactData {
    const message = createBasePreCompactData();
    message.taskId = object.taskId ?? "";
