...
export const TranscribeAudioRequest: MessageFns<TranscribeAudioRequest> = {
  ...
  fromPartial(object: DeepPartial<TranscribeAudioRequest>): TranscribeAudioRequest {
    const message = createBaseTranscribeAudioRequest();
...
export interface DictationServiceImplementation<CallContextExt = {}> {
  startRecording(request: EmptyRequest, context: CallContext & CallContextExt): Promise<DeepPartial<RecordingResult>>;
  stopRecording(request: EmptyRequest, context: CallContext & CallContextExt): Promise<DeepPartial<RecordedAudio>>;
  cancelRecording(request: EmptyRequest, context: CallContext & CallContextExt): Promise<DeepPartial<RecordingResult>>;
  getRecordingStatus(
...
export interface DictationServiceClient<CallOptionsExt = {}> {
  startRecording(request: DeepPartial<EmptyRequest>, options?: CallOptions & CallOptionsExt): Promise<RecordingResult>;
  stopRecording(request: DeepPartial<EmptyRequest>, options?: CallOptions & CallOptionsExt): Promise<RecordedAudio>;
  cancelRecording(request: DeepPartial<EmptyRequest>, options?: CallOptions & CallOptionsExt): Promise<RecordingResult>;
  getRecordingStatus(
