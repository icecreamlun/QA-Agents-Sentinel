...
export const WindowServiceService = {
  /** Opens a text document in the IDE editor and returns editor information. */
  showTextDocument: {
    path: "/host.WindowService/showTextDocument",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: ShowTextDocumentRequest) => Buffer.from(ShowTextDocumentRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => ShowTextDocumentRequest.decode(value),
    responseSerialize: (value: TextEditorInfo) => Buffer.from(TextEditorInfo.encode(value).finish()),
    responseDeserialize: (value: Buffer) => TextEditorInfo.decode(value),
  },
  /** Shows the open file dialogue / file picker. */
  showOpenDialogue: {
    path: "/host.WindowService/showOpenDialogue",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: ShowOpenDialogueRequest) => Buffer.from(ShowOpenDialogueRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => ShowOpenDialogueRequest.decode(value),
    responseSerialize: (value: SelectedResources) => Buffer.from(SelectedResources.encode(value).finish()),
    responseDeserialize: (value: Buffer) => SelectedResources.decode(value),
  },
  /** Shows a notification. */
  showMessage: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: ShowMessageRequest) => Buffer.from(ShowMessageRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => ShowMessageRequest.decode(value),
    responseSerialize: (value: SelectedResponse) => Buffer.from(SelectedResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => SelectedResponse.decode(value),
  },
  /** Prompts the user for input and returns the response. */
  showInputBox: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: ShowInputBoxRequest) => Buffer.from(ShowInputBoxRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => ShowInputBoxRequest.decode(value),
    responseSerialize: (value: ShowInputBoxResponse) => Buffer.from(ShowInputBoxResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => ShowInputBoxResponse.decode(value),
  },
  /** Shows the file save dialogue / file picker. */
  showSaveDialog: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: ShowSaveDialogRequest) => Buffer.from(ShowSaveDialogRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => ShowSaveDialogRequest.decode(value),
    responseSerialize: (value: ShowSaveDialogResponse) => Buffer.from(ShowSaveDialogResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => ShowSaveDialogResponse.decode(value),
  },
  /** Opens a file in the IDE. */
  openFile: {
    ...
    responseSerialize: (value: OpenFileResponse) => Buffer.from(OpenFileResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => OpenFileResponse.decode(value),
  },
  /** Opens the host settings UI, optionally focusing a specific query/section. */
  openSettings: {
    path: "/host.WindowService/openSettings",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: OpenSettingsRequest) => Buffer.from(OpenSettingsRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => OpenSettingsRequest.decode(value),
    responseSerialize: (value: OpenSettingsResponse) => Buffer.from(OpenSettingsResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => OpenSettingsResponse.decode(value),
  },
  /** Returns the open tabs. */
  getOpenTabs: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: GetOpenTabsRequest) => Buffer.from(GetOpenTabsRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => GetOpenTabsRequest.decode(value),
    responseSerialize: (value: GetOpenTabsResponse) => Buffer.from(GetOpenTabsResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => GetOpenTabsResponse.decode(value),
  },
  /** Returns the visible tabs. */
  getVisibleTabs: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: GetVisibleTabsRequest) => Buffer.from(GetVisibleTabsRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => GetVisibleTabsRequest.decode(value),
    responseSerialize: (value: GetVisibleTabsResponse) => Buffer.from(GetVisibleTabsResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => GetVisibleTabsResponse.decode(value),
  },
  /** Returns information about the current editor */
  getActiveEditor: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: GetActiveEditorRequest) => Buffer.from(GetActiveEditorRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => GetActiveEditorRequest.decode(value),
    responseSerialize: (value: GetActiveEditorResponse) => Buffer.from(GetActiveEditorResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => GetActiveEditorResponse.decode(value),
  },
} as const;
...
export interface WindowServiceServer extends UntypedServiceImplementation {
  ...
  /** Opens the host settings UI, optionally focusing a specific query/section. */
  openSettings: handleUnaryCall<OpenSettingsRequest, OpenSettingsResponse>;
  /** Returns the open tabs. */
  ...
  /** Returns information about the current editor */
  getActiveEditor: handleUnaryCall<GetActiveEditorRequest, GetActiveEditorResponse>;
}

export interface WindowServiceClient extends Client {
  /** Opens a text document in the IDE editor and returns editor information. */
  showTextDocument(
    request: ShowTextDocumentRequest,
    callback: (error: ServiceError | null, response: TextEditorInfo) => void,
  ): ClientUnaryCall;
  showTextDocument(
    request: ShowTextDocumentRequest,
    metadata: Metadata,
  ...
  showOpenDialogue(
    ...
    callback: (error: ServiceError | null, response: SelectedResources) => void,
  ): ClientUnaryCall;
  showOpenDialogue(
    request: ShowOpenDialogueRequest,
    metadata: Metadata,
  ...
  showMessage(
    ...
    callback: (error: ServiceError | null, response: SelectedResponse) => void,
  ): ClientUnaryCall;
  showMessage(
    request: ShowMessageRequest,
    metadata: Metadata,
  ...
  showInputBox(
    ...
    callback: (error: ServiceError | null, response: ShowInputBoxResponse) => void,
  ): ClientUnaryCall;
  showInputBox(
    request: ShowInputBoxRequest,
    metadata: Metadata,
  ...
  showSaveDialog(
    ...
    callback: (error: ServiceError | null, response: ShowSaveDialogResponse) => void,
  ): ClientUnaryCall;
  showSaveDialog(
    request: ShowSaveDialogRequest,
    metadata: Metadata,
  ...
  openFile(
    ...
    callback: (error: ServiceError | null, response: OpenFileResponse) => void,
  ): ClientUnaryCall;
  openFile(
    request: OpenFileRequest,
    metadata: Metadata,
  ...
  openSettings(
    ...
    callback: (error: ServiceError | null, response: OpenSettingsResponse) => void,
  ): ClientUnaryCall;
  openSettings(
    request: OpenSettingsRequest,
    metadata: Metadata,
  ...
  getOpenTabs(
    ...
    callback: (error: ServiceError | null, response: GetOpenTabsResponse) => void,
  ): ClientUnaryCall;
  getOpenTabs(
    request: GetOpenTabsRequest,
    metadata: Metadata,
  ...
  getVisibleTabs(
    ...
    callback: (error: ServiceError | null, response: GetVisibleTabsResponse) => void,
  ): ClientUnaryCall;
  getVisibleTabs(
    request: GetVisibleTabsRequest,
    metadata: Metadata,
  ...
  getActiveEditor(
    ...
    callback: (error: ServiceError | null, response: GetActiveEditorResponse) => void,
  ): ClientUnaryCall;
  getActiveEditor(
    request: GetActiveEditorRequest,
    metadata: Metadata,
...
export const WindowServiceClient = makeGenericClientConstructor(
  WindowServiceService,
  "host.WindowService",
) as unknown as {
  new (address: string, credentials: ChannelCredentials, options?: Partial<ClientOptions>): WindowServiceClient;
  service: typeof WindowServiceService;
  serviceName: string;
};
