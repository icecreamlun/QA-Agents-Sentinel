...
import { Metadata as Metadata1 } from "../cline/common";
...
export const ContentDiff: MessageFns<ContentDiff> = {
  ...
  fromJSON(object: any): ContentDiff {
    return {
      ...
      leftContent: isSet(object.leftContent) ? globalThis.String(object.leftContent) : undefined,
      rightContent: isSet(object.rightContent) ? globalThis.String(object.rightContent) : undefined,
    };
  },
...
export const DiffServiceService = {
  ...
  openDiff: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: OpenDiffRequest) => Buffer.from(OpenDiffRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => OpenDiffRequest.decode(value),
    responseSerialize: (value: OpenDiffResponse) => Buffer.from(OpenDiffResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => OpenDiffResponse.decode(value),
  },
  /** Get the contents of the diff view. */
  getDocumentText: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: GetDocumentTextRequest) => Buffer.from(GetDocumentTextRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => GetDocumentTextRequest.decode(value),
    responseSerialize: (value: GetDocumentTextResponse) => Buffer.from(GetDocumentTextResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => GetDocumentTextResponse.decode(value),
  },
  /** Replace a text selection in the diff. */
  replaceText: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: ReplaceTextRequest) => Buffer.from(ReplaceTextRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => ReplaceTextRequest.decode(value),
    responseSerialize: (value: ReplaceTextResponse) => Buffer.from(ReplaceTextResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => ReplaceTextResponse.decode(value),
  },
  scrollDiff: {
    path: "/host.DiffService/scrollDiff",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: ScrollDiffRequest) => Buffer.from(ScrollDiffRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => ScrollDiffRequest.decode(value),
    responseSerialize: (value: ScrollDiffResponse) => Buffer.from(ScrollDiffResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => ScrollDiffResponse.decode(value),
  },
  /** Truncate the diff document. */
  truncateDocument: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: TruncateDocumentRequest) => Buffer.from(TruncateDocumentRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => TruncateDocumentRequest.decode(value),
    responseSerialize: (value: TruncateDocumentResponse) =>
      Buffer.from(TruncateDocumentResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => TruncateDocumentResponse.decode(value),
  },
  /** Save the diff document. */
  saveDocument: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: SaveDocumentRequest) => Buffer.from(SaveDocumentRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => SaveDocumentRequest.decode(value),
    responseSerialize: (value: SaveDocumentResponse) => Buffer.from(SaveDocumentResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => SaveDocumentResponse.decode(value),
  },
  /**
   * Close all the diff editor windows/tabs.
   * Any diff editors with unsaved content should not be closed.
  ...
  closeAllDiffs: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: CloseAllDiffsRequest) => Buffer.from(CloseAllDiffsRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => CloseAllDiffsRequest.decode(value),
    responseSerialize: (value: CloseAllDiffsResponse) => Buffer.from(CloseAllDiffsResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => CloseAllDiffsResponse.decode(value),
  },
  /**
   * Display a diff view comparing before/after states for multiple files.
   * Content is passed as in-memory data, not read from the file system.
  ...
  openMultiFileDiff: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: OpenMultiFileDiffRequest) => Buffer.from(OpenMultiFileDiffRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => OpenMultiFileDiffRequest.decode(value),
    responseSerialize: (value: OpenMultiFileDiffResponse) =>
      Buffer.from(OpenMultiFileDiffResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => OpenMultiFileDiffResponse.decode(value),
  },
} as const;

export interface DiffServiceServer extends UntypedServiceImplementation {
  /** Open the diff view/editor. */
  openDiff: handleUnaryCall<OpenDiffRequest, OpenDiffResponse>;
  /** Get the contents of the diff view. */
  getDocumentText: handleUnaryCall<GetDocumentTextRequest, GetDocumentTextResponse>;
  /** Replace a text selection in the diff. */
  replaceText: handleUnaryCall<ReplaceTextRequest, ReplaceTextResponse>;
  scrollDiff: handleUnaryCall<ScrollDiffRequest, ScrollDiffResponse>;
  /** Truncate the diff document. */
  truncateDocument: handleUnaryCall<TruncateDocumentRequest, TruncateDocumentResponse>;
  /** Save the diff document. */
  saveDocument: handleUnaryCall<SaveDocumentRequest, SaveDocumentResponse>;
  /**
   * Close all the diff editor windows/tabs.
   * Any diff editors with unsaved content should not be closed.
   */
  closeAllDiffs: handleUnaryCall<CloseAllDiffsRequest, CloseAllDiffsResponse>;
  /**
   * Display a diff view comparing before/after states for multiple files.
   * Content is passed as in-memory data, not read from the file system.
   */
  openMultiFileDiff: handleUnaryCall<OpenMultiFileDiffRequest, OpenMultiFileDiffResponse>;
}
...
export interface DiffServiceClient extends Client {
  ...
  openDiff(
    ...
    callback: (error: ServiceError | null, response: OpenDiffResponse) => void,
  ): ClientUnaryCall;
  openDiff(
    request: OpenDiffRequest,
    metadata: Metadata,
  ...
  getDocumentText(
    ...
    callback: (error: ServiceError | null, response: GetDocumentTextResponse) => void,
  ): ClientUnaryCall;
  getDocumentText(
    request: GetDocumentTextRequest,
    metadata: Metadata,
  ...
  replaceText(
    ...
    callback: (error: ServiceError | null, response: ReplaceTextResponse) => void,
  ): ClientUnaryCall;
  replaceText(
    request: ReplaceTextRequest,
    metadata: Metadata,
  ...
  scrollDiff(
    ...
    callback: (error: ServiceError | null, response: ScrollDiffResponse) => void,
  ): ClientUnaryCall;
  scrollDiff(
    request: ScrollDiffRequest,
    metadata: Metadata,
  ...
  truncateDocument(
    ...
    callback: (error: ServiceError | null, response: TruncateDocumentResponse) => void,
  ): ClientUnaryCall;
  truncateDocument(
    request: TruncateDocumentRequest,
    metadata: Metadata,
  ...
  saveDocument(
    ...
    callback: (error: ServiceError | null, response: SaveDocumentResponse) => void,
  ): ClientUnaryCall;
  saveDocument(
    request: SaveDocumentRequest,
    metadata: Metadata,
  ...
  closeAllDiffs(
    ...
    callback: (error: ServiceError | null, response: CloseAllDiffsResponse) => void,
  ): ClientUnaryCall;
  closeAllDiffs(
    request: CloseAllDiffsRequest,
    metadata: Metadata,
  ...
  openMultiFileDiff(
    ...
    callback: (error: ServiceError | null, response: OpenMultiFileDiffResponse) => void,
  ): ClientUnaryCall;
  openMultiFileDiff(
    request: OpenMultiFileDiffRequest,
    metadata: Metadata,
...
export const DiffServiceClient = makeGenericClientConstructor(DiffServiceService, "host.DiffService") as unknown as {
