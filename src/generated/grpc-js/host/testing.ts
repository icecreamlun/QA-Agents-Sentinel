...
export const TestingServiceService = {
  getWebviewHtml: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: GetWebviewHtmlRequest) => Buffer.from(GetWebviewHtmlRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => GetWebviewHtmlRequest.decode(value),
    responseSerialize: (value: GetWebviewHtmlResponse) => Buffer.from(GetWebviewHtmlResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => GetWebviewHtmlResponse.decode(value),
  },
} as const;

export interface TestingServiceServer extends UntypedServiceImplementation {
  getWebviewHtml: handleUnaryCall<GetWebviewHtmlRequest, GetWebviewHtmlResponse>;
}

export interface TestingServiceClient extends Client {
  getWebviewHtml(
    request: GetWebviewHtmlRequest,
    callback: (error: ServiceError | null, response: GetWebviewHtmlResponse) => void,
  ): ClientUnaryCall;
  getWebviewHtml(
    request: GetWebviewHtmlRequest,
    metadata: Metadata,
...
export const TestingServiceClient = makeGenericClientConstructor(
  ...
  new (address: string, credentials: ChannelCredentials, options?: Partial<ClientOptions>): TestingServiceClient;
