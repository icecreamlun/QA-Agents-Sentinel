...
export const OpenTerminalRequest: MessageFns<OpenTerminalRequest> = {
  ...
  create<I extends Exact<DeepPartial<OpenTerminalRequest>, I>>(base?: I): OpenTerminalRequest {
    return OpenTerminalRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<OpenTerminalRequest>, I>>(_: I): OpenTerminalRequest {
    const message = createBaseOpenTerminalRequest();
    return message;
  },
};
...
export const OpenTerminalResponse: MessageFns<OpenTerminalResponse> = {
  ...
  create<I extends Exact<DeepPartial<OpenTerminalResponse>, I>>(base?: I): OpenTerminalResponse {
    return OpenTerminalResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<OpenTerminalResponse>, I>>(_: I): OpenTerminalResponse {
    const message = createBaseOpenTerminalResponse();
    return message;
  },
};
...
export const ExecuteCommandInTerminalResponse: MessageFns<ExecuteCommandInTerminalResponse> = {
  ...
  fromPartial<I extends Exact<DeepPartial<ExecuteCommandInTerminalResponse>, I>>(
    object: I,
  ): ExecuteCommandInTerminalResponse {
    const message = createBaseExecuteCommandInTerminalResponse();
...
export const WorkspaceServiceService = {
  ...
  openTerminalPanel: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: OpenTerminalRequest) => Buffer.from(OpenTerminalRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => OpenTerminalRequest.decode(value),
    responseSerialize: (value: OpenTerminalResponse) => Buffer.from(OpenTerminalResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => OpenTerminalResponse.decode(value),
  },
  /** Executes a command in a new terminal */
  executeCommandInTerminal: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: ExecuteCommandInTerminalRequest) =>
      Buffer.from(ExecuteCommandInTerminalRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => ExecuteCommandInTerminalRequest.decode(value),
    responseSerialize: (value: ExecuteCommandInTerminalResponse) =>
      Buffer.from(ExecuteCommandInTerminalResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => ExecuteCommandInTerminalResponse.decode(value),
  },
} as const;
...
export interface WorkspaceServiceServer extends UntypedServiceImplementation {
  ...
  /** Executes a command in a new terminal */
  executeCommandInTerminal: handleUnaryCall<ExecuteCommandInTerminalRequest, ExecuteCommandInTerminalResponse>;
}
...
export interface WorkspaceServiceClient extends Client {
  ...
  openTerminalPanel(
    ...
    callback: (error: ServiceError | null, response: OpenTerminalResponse) => void,
  ): ClientUnaryCall;
  openTerminalPanel(
    request: OpenTerminalRequest,
    metadata: Metadata,
  ...
  executeCommandInTerminal(
    ...
    callback: (error: ServiceError | null, response: ExecuteCommandInTerminalResponse) => void,
  ): ClientUnaryCall;
  executeCommandInTerminal(
    request: ExecuteCommandInTerminalRequest,
    metadata: Metadata,
