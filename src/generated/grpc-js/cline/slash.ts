...
export const SlashCommandInfo: MessageFns<SlashCommandInfo> = {
  ...
  fromJSON(object: any): SlashCommandInfo {
    return {
      ...
      cliCompatible: isSet(object.cliCompatible) ? globalThis.Boolean(object.cliCompatible) : false,
    };
  },
...
export const SlashServiceService = {
  ...
  getAvailableSlashCommands: {
    ...
    responseSerialize: (value: SlashCommandsResponse) => Buffer.from(SlashCommandsResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => SlashCommandsResponse.decode(value),
  },
} as const;
