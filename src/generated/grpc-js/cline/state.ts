...
export const StateServiceService = {
  ...
  updateSettingsCli: {
    path: "/cline.StateService/updateSettingsCli",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: UpdateSettingsRequestCli) => Buffer.from(UpdateSettingsRequestCli.encode(value).finish()),
    requestDeserialize: (value: Buffer) => UpdateSettingsRequestCli.decode(value),
    responseSerialize: (value: Empty) => Buffer.from(Empty.encode(value).finish()),
    responseDeserialize: (value: Buffer) => Empty.decode(value),
  },
  updateTaskSettings: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: UpdateTaskSettingsRequest) =>
      Buffer.from(UpdateTaskSettingsRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => UpdateTaskSettingsRequest.decode(value),
    responseSerialize: (value: Empty) => Buffer.from(Empty.encode(value).finish()),
    responseDeserialize: (value: Buffer) => Empty.decode(value),
  },
  updateTelemetrySetting: {
  ...
  captureOnboardingProgress: {
    path: "/cline.StateService/captureOnboardingProgress",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: OnboardingProgressRequest) =>
      Buffer.from(OnboardingProgressRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => OnboardingProgressRequest.decode(value),
    responseSerialize: (value: Empty) => Buffer.from(Empty.encode(value).finish()),
    responseDeserialize: (value: Buffer) => Empty.decode(value),
  },
  setWelcomeViewCompleted: {
  ...
  dismissBanner: {
    path: "/cline.StateService/dismissBanner",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: StringRequest) => Buffer.from(StringRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => StringRequest.decode(value),
  ...
  trackBannerEvent: {
    path: "/cline.StateService/trackBannerEvent",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: TrackBannerEventRequest) => Buffer.from(TrackBannerEventRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => TrackBannerEventRequest.decode(value),
    responseSerialize: (value: Empty) => Buffer.from(Empty.encode(value).finish()),
    responseDeserialize: (value: Buffer) => Empty.decode(value),
  },
  installClineCli: {
  ...
  getProcessInfo: {
    ...
    requestSerialize: (value: EmptyRequest) => Buffer.from(EmptyRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => EmptyRequest.decode(value),
    responseSerialize: (value: ProcessInfo) => Buffer.from(ProcessInfo.encode(value).finish()),
    responseDeserialize: (value: Buffer) => ProcessInfo.decode(value),
  },
  flushPendingState: {
    path: "/cline.StateService/flushPendingState",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: EmptyRequest) => Buffer.from(EmptyRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => EmptyRequest.decode(value),
...
export interface StateServiceServer extends UntypedServiceImplementation {
  ...
  updateSettingsCli: handleUnaryCall<UpdateSettingsRequestCli, Empty>;
  updateTaskSettings: handleUnaryCall<UpdateTaskSettingsRequest, Empty>;
  updateTelemetrySetting: handleUnaryCall<TelemetrySettingRequest, Empty>;
  captureOnboardingProgress: handleUnaryCall<OnboardingProgressRequest, Empty>;
  setWelcomeViewCompleted: handleUnaryCall<BooleanRequest, Empty>;
  updateInfoBannerVersion: handleUnaryCall<Int64Request, Empty>;
  updateModelBannerVersion: handleUnaryCall<Int64Request, Empty>;
  updateCliBannerVersion: handleUnaryCall<Int64Request, Empty>;
  dismissBanner: handleUnaryCall<StringRequest, Empty>;
  trackBannerEvent: handleUnaryCall<TrackBannerEventRequest, Empty>;
  installClineCli: handleUnaryCall<EmptyRequest, Empty>;
  checkCliInstallation: handleUnaryCall<EmptyRequest, Boolean>;
  getProcessInfo: handleUnaryCall<EmptyRequest, ProcessInfo>;
  flushPendingState: handleUnaryCall<EmptyRequest, Empty>;
}
...
export interface StateServiceClient extends Client {
  ...
  getProcessInfo(
    request: EmptyRequest,
    callback: (error: ServiceError | null, response: ProcessInfo) => void,
  ): ClientUnaryCall;
  getProcessInfo(
    request: EmptyRequest,
    metadata: Metadata,
