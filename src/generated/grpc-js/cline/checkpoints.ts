...
export const PathHashMap: MessageFns<PathHashMap> = {
  ...
  fromJSON(object: any): PathHashMap {
    return {
      pathHash: isObject(object.pathHash)
        ? Object.entries(object.pathHash).reduce<{ [key: string]: string }>((acc, [key, value]) => {
  ...
  fromPartial<I extends Exact<DeepPartial<PathHashMap>, I>>(object: I): PathHashMap {
    const message = createBasePathHashMap();
    message.pathHash = Object.entries(object.pathHash ?? {}).reduce<{ [key: string]: string }>((acc, [key, value]) => {
      if (value !== undefined) {
...
export const CheckpointsServiceService = {
  ...
  subscribeToCheckpoints: {
    ...
    requestStream: false,
    responseStream: true,
    requestSerialize: (value: CheckpointSubscriptionRequest) =>
      Buffer.from(CheckpointSubscriptionRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => CheckpointSubscriptionRequest.decode(value),
    responseSerialize: (value: CheckpointEvent) => Buffer.from(CheckpointEvent.encode(value).finish()),
    responseDeserialize: (value: Buffer) => CheckpointEvent.decode(value),
  },
  getCwdHash: {
    ...
    responseSerialize: (value: PathHashMap) => Buffer.from(PathHashMap.encode(value).finish()),
    responseDeserialize: (value: Buffer) => PathHashMap.decode(value),
  },
} as const;
