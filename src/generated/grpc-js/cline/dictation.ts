...
export const RecordingResult: MessageFns<RecordingResult> = {
  encode(message: RecordingResult, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  create<I extends Exact<DeepPartial<RecordingResult>, I>>(base?: I): RecordingResult {
    return RecordingResult.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<RecordingResult>, I>>(object: I): RecordingResult {
    const message = createBaseRecordingResult();
...
export const RecordedAudio: MessageFns<RecordedAudio> = {
  encode(message: RecordedAudio, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.success !== false) {
      writer.uint32(8).bool(message.success);
    }
    if (message.audioBase64 !== "") {
  ...
  create<I extends Exact<DeepPartial<RecordedAudio>, I>>(base?: I): RecordedAudio {
    return RecordedAudio.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<RecordedAudio>, I>>(object: I): RecordedAudio {
    const message = createBaseRecordedAudio();
    message.success = object.success ?? false;
    message.audioBase64 = object.audioBase64 ?? "";
    message.error = object.error ?? "";
...
export const RecordingStatus: MessageFns<RecordingStatus> = {
  encode(message: RecordingStatus, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  create<I extends Exact<DeepPartial<RecordingStatus>, I>>(base?: I): RecordingStatus {
    return RecordingStatus.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<RecordingStatus>, I>>(object: I): RecordingStatus {
    const message = createBaseRecordingStatus();
...
export const DictationServiceService = {
  startRecording: {
    ...
    responseSerialize: (value: RecordingResult) => Buffer.from(RecordingResult.encode(value).finish()),
    responseDeserialize: (value: Buffer) => RecordingResult.decode(value),
  },
  stopRecording: {
    ...
    requestSerialize: (value: EmptyRequest) => Buffer.from(EmptyRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => EmptyRequest.decode(value),
    responseSerialize: (value: RecordedAudio) => Buffer.from(RecordedAudio.encode(value).finish()),
    responseDeserialize: (value: Buffer) => RecordedAudio.decode(value),
  },
  cancelRecording: {
  ...
  getRecordingStatus: {
    ...
    requestSerialize: (value: EmptyRequest) => Buffer.from(EmptyRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => EmptyRequest.decode(value),
    responseSerialize: (value: RecordingStatus) => Buffer.from(RecordingStatus.encode(value).finish()),
    responseDeserialize: (value: Buffer) => RecordingStatus.decode(value),
  },
  transcribeAudio: {
    path: "/cline.DictationService/transcribeAudio",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: TranscribeAudioRequest) => Buffer.from(TranscribeAudioRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => TranscribeAudioRequest.decode(value),
    responseSerialize: (value: Transcription) => Buffer.from(Transcription.encode(value).finish()),
    responseDeserialize: (value: Buffer) => Transcription.decode(value),
  },
} as const;
...
export const DictationServiceClient = makeGenericClientConstructor(
  ...
  new (address: string, credentials: ChannelCredentials, options?: Partial<ClientOptions>): DictationServiceClient;
