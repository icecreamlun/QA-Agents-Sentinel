...
export function clineSayFromJSON(object: any): ClineSay {
  switch (object) {
    ...
    case "SENTINEL_QA_REPORT":
      return ClineSay.SENTINEL_QA_REPORT;
    case -1:
    case "UNRECOGNIZED":
    default:
...
export function clineSayToJSON(object: ClineSay): string {
  switch (object) {
    ...
    case ClineSay.SENTINEL_QA_REPORT:
      return "SENTINEL_QA_REPORT";
...
export const ClineMessage: MessageFns<ClineMessage> = {
  ...
  fromJSON(object: any): ClineMessage {
    return {
      ...
      modelInfo: isSet(object.modelInfo) ? ClineModelInfo.fromJSON(object.modelInfo) : undefined,
    };
  },
...
export const ShowWebviewEvent: MessageFns<ShowWebviewEvent> = {
  ...
  fromJSON(object: any): ShowWebviewEvent {
    return {
      preserveEditorFocus: isSet(object.preserveEditorFocus) ? globalThis.Boolean(object.preserveEditorFocus) : false,
    };
  },
...
export const UiServiceService = {
  ...
  /** Subscribe to show webview events */
  subscribeToShowWebview: {
    path: "/cline.UiService/subscribeToShowWebview",
    requestStream: false,
    responseStream: true,
    requestSerialize: (value: EmptyRequest) => Buffer.from(EmptyRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => EmptyRequest.decode(value),
    responseSerialize: (value: ShowWebviewEvent) => Buffer.from(ShowWebviewEvent.encode(value).finish()),
    responseDeserialize: (value: Buffer) => ShowWebviewEvent.decode(value),
  },
  /** Returns the HTML for the webview index page. This is only used by external clients, not by the vscode webview. */
  getWebviewHtml: {
...
export interface UiServiceServer extends UntypedServiceImplementation {
  ...
  /** Sets the terminal execution mode (vscodeTerminal or backgroundExec) */
  setTerminalExecutionMode: handleUnaryCall<BooleanRequest, KeyValuePair>;
  /** Marks the current announcement as shown and returns whether an announcement should still be shown */
  onDidShowAnnouncement: handleUnaryCall<EmptyRequest, Boolean>;
  /** Subscribe to addToInput events (when user adds content via context menu) */
  subscribeToAddToInput: handleServerStreamingCall<EmptyRequest, String>;
  /** Subscribe to MCP button clicked events */
  subscribeToMcpButtonClicked: handleServerStreamingCall<EmptyRequest, Empty>;
  /** Subscribe to history button click events */
  subscribeToHistoryButtonClicked: handleServerStreamingCall<EmptyRequest, Empty>;
  /** Subscribe to chat button clicked events (when the chat button is clicked in VSCode) */
  ...
  /** Subscribe to settings button clicked events */
  subscribeToSettingsButtonClicked: handleServerStreamingCall<EmptyRequest, Empty>;
  /** Subscribe to partial message updates (streaming Cline messages as they're built) */
  ...
  /** Subscribe to show webview events */
  subscribeToShowWebview: handleServerStreamingCall<EmptyRequest, ShowWebviewEvent>;
  /** Returns the HTML for the webview index page. This is only used by external clients, not by the vscode webview. */
...
export interface UiServiceClient extends Client {
  ...
  /** Subscribe to addToInput events (when user adds content via context menu) */
  subscribeToAddToInput(request: EmptyRequest, options?: Partial<CallOptions>): ClientReadableStream<String>;
  subscribeToAddToInput(
    request: EmptyRequest,
    metadata?: Metadata,
    options?: Partial<CallOptions>,
  ...
  /** Subscribe to MCP button clicked events */
  subscribeToMcpButtonClicked(request: EmptyRequest, options?: Partial<CallOptions>): ClientReadableStream<Empty>;
  subscribeToMcpButtonClicked(
    request: EmptyRequest,
    metadata?: Metadata,
    options?: Partial<CallOptions>,
  ...
  /** Subscribe to history button click events */
  subscribeToHistoryButtonClicked(request: EmptyRequest, options?: Partial<CallOptions>): ClientReadableStream<Empty>;
  subscribeToHistoryButtonClicked(
    request: EmptyRequest,
    metadata?: Metadata,
    options?: Partial<CallOptions>,
  ...
  /** Subscribe to settings button clicked events */
  subscribeToSettingsButtonClicked(request: EmptyRequest, options?: Partial<CallOptions>): ClientReadableStream<Empty>;
  subscribeToSettingsButtonClicked(
    request: EmptyRequest,
    metadata?: Metadata,
    options?: Partial<CallOptions>,
  ...
  /** Subscribe to show webview events */
  subscribeToShowWebview(request: EmptyRequest, options?: Partial<CallOptions>): ClientReadableStream<ShowWebviewEvent>;
  subscribeToShowWebview(
    request: EmptyRequest,
    metadata?: Metadata,
    options?: Partial<CallOptions>,
  ): ClientReadableStream<ShowWebviewEvent>;
  /** Returns the HTML for the webview index page. This is only used by external clients, not by the vscode webview. */
  getWebviewHtml(
    request: EmptyRequest,
