...
export const FileSearchRequest: MessageFns<FileSearchRequest> = {
  ...
  fromJSON(object: any): FileSearchRequest {
    return {
      ...
      workspaceHint: isSet(object.workspaceHint) ? globalThis.String(object.workspaceHint) : undefined,
    };
  },
...
export const FileInfo: MessageFns<FileInfo> = {
  ...
  fromJSON(object: any): FileInfo {
    return {
      ...
      workspaceName: isSet(object.workspaceName) ? globalThis.String(object.workspaceName) : undefined,
    };
  },
...
export const HookInfo: MessageFns<HookInfo> = {
  ...
  fromJSON(object: any): HookInfo {
    return {
      ...
      enabled: isSet(object.enabled) ? globalThis.Boolean(object.enabled) : false,
      absolutePath: isSet(object.absolutePath) ? globalThis.String(object.absolutePath) : "",
    };
  },
  ...
  fromJSON(object: any): HooksToggles {
    return {
      ...
      workspaceHooks: globalThis.Array.isArray(object?.workspaceHooks)
        ...
        : [],
      isWindows: isSet(object.isWindows) ? globalThis.Boolean(object.isWindows) : false,
    };
  },
...
export const ToggleHookResponse: MessageFns<ToggleHookResponse> = {
  ...
  fromJSON(object: any): ToggleHookResponse {
    return { hooksToggles: isSet(object.hooksToggles) ? HooksToggles.fromJSON(object.hooksToggles) : undefined };
  },
...
export const SkillsToggles: MessageFns<SkillsToggles> = {
  encode(message: SkillsToggles, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    Object.entries(message.globalSkillsToggles).forEach(([key, value]) => {
      SkillsToggles_GlobalSkillsTogglesEntry.encode({ key: key as any, value }, writer.uint32(10).fork()).join();
    });
    Object.entries(message.localSkillsToggles).forEach(([key, value]) => {
  ...
  fromJSON(object: any): SkillsToggles {
    return {
      globalSkillsToggles: isObject(object.globalSkillsToggles)
        ? Object.entries(object.globalSkillsToggles).reduce<{ [key: string]: boolean }>((acc, [key, value]) => {
          acc[key] = Boolean(value);
          return acc;
        }, {})
        : {},
      localSkillsToggles: isObject(object.localSkillsToggles)
        ? Object.entries(object.localSkillsToggles).reduce<{ [key: string]: boolean }>((acc, [key, value]) => {
          acc[key] = Boolean(value);
          return acc;
        }, {})
        : {},
  ...
  toJSON(message: SkillsToggles): unknown {
    ...
    if (message.globalSkillsToggles) {
      const entries = Object.entries(message.globalSkillsToggles);
      if (entries.length > 0) {
    ...
    if (message.localSkillsToggles) {
      const entries = Object.entries(message.localSkillsToggles);
      if (entries.length > 0) {
  ...
  fromPartial<I extends Exact<DeepPartial<SkillsToggles>, I>>(object: I): SkillsToggles {
    const message = createBaseSkillsToggles();
    message.globalSkillsToggles = Object.entries(object.globalSkillsToggles ?? {}).reduce<{ [key: string]: boolean }>(
      (acc, [key, value]) => {
        if (value !== undefined) {
          acc[key] = globalThis.Boolean(value);
        }
    ...
    message.localSkillsToggles = Object.entries(object.localSkillsToggles ?? {}).reduce<{ [key: string]: boolean }>(
      (acc, [key, value]) => {
        if (value !== undefined) {
          acc[key] = globalThis.Boolean(value);
        }
...
export const ToggleSkillRequest: MessageFns<ToggleSkillRequest> = {
  ...
  fromJSON(object: any): ToggleSkillRequest {
    return {
      metadata: isSet(object.metadata) ? Metadata1.fromJSON(object.metadata) : undefined,
      skillPath: isSet(object.skillPath) ? globalThis.String(object.skillPath) : "",
      isGlobal: isSet(object.isGlobal) ? globalThis.Boolean(object.isGlobal) : false,
      enabled: isSet(object.enabled) ? globalThis.Boolean(object.enabled) : false,
    };
  },
...
export const FileServiceService = {
  ...
  /** Toggle an Agents rule (enable or disable) */
  toggleAgentsRule: {
    path: "/cline.FileService/toggleAgentsRule",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: ToggleAgentsRuleRequest) => Buffer.from(ToggleAgentsRuleRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => ToggleAgentsRuleRequest.decode(value),
    responseSerialize: (value: ClineRulesToggles) => Buffer.from(ClineRulesToggles.encode(value).finish()),
    responseDeserialize: (value: Buffer) => ClineRulesToggles.decode(value),
  },
  /** Refreshes all rule toggles (Cline, External, and Workflows) */
  ...
  /** Opens a task's conversation history file on disk */
  openDiskConversationHistory: {
    path: "/cline.FileService/openDiskConversationHistory",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: StringRequest) => Buffer.from(StringRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => StringRequest.decode(value),
  ...
  /** Refreshes all hook toggles (discovers hooks and their enabled state) */
  refreshHooks: {
    path: "/cline.FileService/refreshHooks",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: EmptyRequest) => Buffer.from(EmptyRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => EmptyRequest.decode(value),
    responseSerialize: (value: HooksToggles) => Buffer.from(HooksToggles.encode(value).finish()),
    responseDeserialize: (value: Buffer) => HooksToggles.decode(value),
  },
  /** Toggles a hook on or off via chmod +x/-x */
  toggleHook: {
    path: "/cline.FileService/toggleHook",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: ToggleHookRequest) => Buffer.from(ToggleHookRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => ToggleHookRequest.decode(value),
    responseSerialize: (value: ToggleHookResponse) => Buffer.from(ToggleHookResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => ToggleHookResponse.decode(value),
  },
  /** Creates a new hook from template */
  createHook: {
    path: "/cline.FileService/createHook",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: CreateHookRequest) => Buffer.from(CreateHookRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => CreateHookRequest.decode(value),
    responseSerialize: (value: CreateHookResponse) => Buffer.from(CreateHookResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => CreateHookResponse.decode(value),
  },
  /** Deletes an existing hook file */
  deleteHook: {
    path: "/cline.FileService/deleteHook",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: DeleteHookRequest) => Buffer.from(DeleteHookRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => DeleteHookRequest.decode(value),
    responseSerialize: (value: DeleteHookResponse) => Buffer.from(DeleteHookResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => DeleteHookResponse.decode(value),
  },
  /** Refreshes all skill toggles (discovers skills and their enabled state) */
  refreshSkills: {
    path: "/cline.FileService/refreshSkills",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: EmptyRequest) => Buffer.from(EmptyRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => EmptyRequest.decode(value),
    responseSerialize: (value: RefreshedSkills) => Buffer.from(RefreshedSkills.encode(value).finish()),
    responseDeserialize: (value: Buffer) => RefreshedSkills.decode(value),
  },
  /** Toggles a skill on or off */
  toggleSkill: {
    path: "/cline.FileService/toggleSkill",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: ToggleSkillRequest) => Buffer.from(ToggleSkillRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => ToggleSkillRequest.decode(value),
    responseSerialize: (value: SkillsToggles) => Buffer.from(SkillsToggles.encode(value).finish()),
    responseDeserialize: (value: Buffer) => SkillsToggles.decode(value),
  },
  /** Creates a new skill from template */
  createSkillFile: {
    path: "/cline.FileService/createSkillFile",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: CreateSkillRequest) => Buffer.from(CreateSkillRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => CreateSkillRequest.decode(value),
    responseSerialize: (value: SkillsToggles) => Buffer.from(SkillsToggles.encode(value).finish()),
    responseDeserialize: (value: Buffer) => SkillsToggles.decode(value),
  },
  /** Deletes an existing skill directory */
  deleteSkillFile: {
    path: "/cline.FileService/deleteSkillFile",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: DeleteSkillRequest) => Buffer.from(DeleteSkillRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => DeleteSkillRequest.decode(value),
    responseSerialize: (value: SkillsToggles) => Buffer.from(SkillsToggles.encode(value).finish()),
    responseDeserialize: (value: Buffer) => SkillsToggles.decode(value),
  },
} as const;
...
export interface FileServiceServer extends UntypedServiceImplementation {
  ...
  /** Toggle an Agents rule (enable or disable) */
  toggleAgentsRule: handleUnaryCall<ToggleAgentsRuleRequest, ClineRulesToggles>;
  /** Refreshes all rule toggles (Cline, External, and Workflows) */
  refreshRules: handleUnaryCall<EmptyRequest, RefreshedRules>;
  /** Opens a task's conversation history file on disk */
  openDiskConversationHistory: handleUnaryCall<StringRequest, Empty>;
  /** Toggles a workflow on or off */
  ...
  /** Refreshes all hook toggles (discovers hooks and their enabled state) */
  refreshHooks: handleUnaryCall<EmptyRequest, HooksToggles>;
  /** Toggles a hook on or off via chmod +x/-x */
  toggleHook: handleUnaryCall<ToggleHookRequest, ToggleHookResponse>;
  /** Creates a new hook from template */
  createHook: handleUnaryCall<CreateHookRequest, CreateHookResponse>;
  /** Deletes an existing hook file */
  deleteHook: handleUnaryCall<DeleteHookRequest, DeleteHookResponse>;
  /** Refreshes all skill toggles (discovers skills and their enabled state) */
  refreshSkills: handleUnaryCall<EmptyRequest, RefreshedSkills>;
  /** Toggles a skill on or off */
  toggleSkill: handleUnaryCall<ToggleSkillRequest, SkillsToggles>;
  /** Creates a new skill from template */
  createSkillFile: handleUnaryCall<CreateSkillRequest, SkillsToggles>;
  /** Deletes an existing skill directory */
  deleteSkillFile: handleUnaryCall<DeleteSkillRequest, SkillsToggles>;
}
...
export interface FileServiceClient extends Client {
  ...
  refreshHooks(
    request: EmptyRequest,
    callback: (error: ServiceError | null, response: HooksToggles) => void,
  ): ClientUnaryCall;
  refreshHooks(
    request: EmptyRequest,
    metadata: Metadata,
  ...
  toggleHook(
    ...
    callback: (error: ServiceError | null, response: ToggleHookResponse) => void,
  ): ClientUnaryCall;
  toggleHook(
    request: ToggleHookRequest,
    metadata: Metadata,
  ...
  createHook(
    ...
    callback: (error: ServiceError | null, response: CreateHookResponse) => void,
  ): ClientUnaryCall;
  createHook(
    request: CreateHookRequest,
    metadata: Metadata,
  ...
  deleteHook(
    ...
    callback: (error: ServiceError | null, response: DeleteHookResponse) => void,
  ): ClientUnaryCall;
  deleteHook(
    request: DeleteHookRequest,
    metadata: Metadata,
  ...
  refreshSkills(
    request: EmptyRequest,
    callback: (error: ServiceError | null, response: RefreshedSkills) => void,
  ): ClientUnaryCall;
  refreshSkills(
    request: EmptyRequest,
    metadata: Metadata,
  ...
  toggleSkill(
    ...
    callback: (error: ServiceError | null, response: SkillsToggles) => void,
  ): ClientUnaryCall;
  toggleSkill(
    request: ToggleSkillRequest,
    metadata: Metadata,
