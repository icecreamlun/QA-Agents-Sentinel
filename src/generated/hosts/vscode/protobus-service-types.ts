...
// Dictation Service Handler Types
export type DictationServiceHandlers = {
     startRecording:(controller: Controller, request: proto.cline.EmptyRequest) => Promise<proto.cline.RecordingResult>
     stopRecording:(controller: Controller, request: proto.cline.EmptyRequest) => Promise<proto.cline.RecordedAudio>
     cancelRecording:(controller: Controller, request: proto.cline.EmptyRequest) => Promise<proto.cline.RecordingResult>
     getRecordingStatus:(controller: Controller, request: proto.cline.EmptyRequest) => Promise<proto.cline.RecordingStatus>
     transcribeAudio:(controller: Controller, request: proto.cline.TranscribeAudioRequest) => Promise<proto.cline.Transcription>
}
