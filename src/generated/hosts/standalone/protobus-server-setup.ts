...
// Dictation Service
import { startRecording } from "@core/controller/dictation/startRecording"
import { stopRecording } from "@core/controller/dictation/stopRecording"
import { cancelRecording } from "@core/controller/dictation/cancelRecording"
import { getRecordingStatus } from "@core/controller/dictation/getRecordingStatus"
import { transcribeAudio } from "@core/controller/dictation/transcribeAudio"
...
export function addProtobusServices(
    ...
    // Dictation Service
    server.addService(cline.DictationServiceService, {
         startRecording: wrapper<cline.EmptyRequest,cline.RecordingResult>(startRecording, controller),
         stopRecording: wrapper<cline.EmptyRequest,cline.RecordedAudio>(stopRecording, controller),
         cancelRecording: wrapper<cline.EmptyRequest,cline.RecordingResult>(cancelRecording, controller),
         getRecordingStatus: wrapper<cline.EmptyRequest,cline.RecordingStatus>(getRecordingStatus, controller),
         transcribeAudio: wrapper<cline.TranscribeAudioRequest,cline.Transcription>(transcribeAudio, controller),
    });
