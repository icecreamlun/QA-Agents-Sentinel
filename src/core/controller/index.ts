...
export class Controller {
	...
	*/
	...
	async initTask(
		...
		const subagentTerminalOutputLineLimit =
			this.stateManager.getGlobalSettingsKey("subagentTerminalOutputLineLimit");
	...
	async getStateToPostToWebview(): Promise<ExtensionState> {
		...
		const dictationSettings =
			this.stateManager.getGlobalSettingsKey("dictationSettings");
		...
		const skillsEnabled =
			this.stateManager.getGlobalSettingsKey("skillsEnabled");
