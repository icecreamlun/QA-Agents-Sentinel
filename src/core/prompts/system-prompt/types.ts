...
export interface PromptVariant {
	...
	readonly componentOverrides: Readonly<
		Partial<Record<SystemPromptSection, ConfigOverride>>
	...
	readonly toolOverrides?: Readonly<
		Partial<Record<ClineDefaultTool, ConfigOverride>>
	>; // Tool customizations
}
...
export function isValidSystemPromptSection(
	section: string,
): section is SystemPromptSection {
	return Object.values(SystemPromptSection).includes(
		section as SystemPromptSection,
	);
}

export function isValidClineDefaultTool(
	tool: string,
): tool is ClineDefaultTool {
